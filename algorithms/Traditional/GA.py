...
class GeneticAlgorithm:
    ...
    def run(self, canvas, draw_path, root):
        ...
        return self.best_path, self.best_distance, total_time
...
class TSPVisualizer:
    ...
    def run(self):
        """ 运行遗传算法并可视化路径 """
        best_path, best_distance, run_time = self.ga.run(self.canvas, self.draw_path, self.root)
        ...
        print(f"Iteration rate: {generations / run_time:.1f} Iterations/second")
